...
const EditUserManage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://8080-ddaedfbeaebcdffcebcccefaedfbdbebed.project.examly.io/usermanage/${id}`, user);
  ...
  const loadData = async () => {
    try {
      const response = await axios.get(`https://8080-ddaedfbeaebcdffcebcccefaedfbdbebed.project.examly.io/usermanage/${id}`);
