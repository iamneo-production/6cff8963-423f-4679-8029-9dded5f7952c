...
export default function CreateUser() {
  ...
  function addUser(e) {
    ...
    if (!formData.name || !formData.surname || !formData.emprole || !formData.emailid || !formData.passw || errors.name ||
      errors.surname || errors.emprole ||  errors.emailid ||   errors.passw) {
      ...
      setErrors((prevErrors) => ({
        ...
        emprole: !formData.empid ? "This field is required." : prevErrors.emprole,
